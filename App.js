    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName={token ? 'Home' : 'Login'}>
                ...
                <Stack.Screen name="DefinitionsScreen" component={DefinitionsScreen}
                              options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="EndofDayScreen" component={EndofDayScreen}
                              options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="AddEndOfDayScreen" component={AddEndOfDayScreen}
                              options={{headerShown: true, title: ''}}/>
                ...
                <Stack.Screen name="ReinstallScreen" component={ReinstallScreen}
                              options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="FreezerScreen" component={FreezerScreen} options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="AddFreezerScreen" component={AddFreezerScreen}
                              options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="LastStockScreen" component={LastStockScreen}
                              options={{headerShown: true, title: ''}}/>
                ...
                <Stack.Screen name="CustomOrderScreen" component={CustomOrderScreen}
                              options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="CustomOrderReportScreen" component={CustomOrderReportScreen}
                              options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="FreezerDefScreen" component={FreezerDefScreen}
                              options={{headerShown: true, title: ''}}/>
                <Stack.Screen name="AllStockScreen" component={AllStockScreen}
                              options={{headerShown: true, title: ''}}/>
